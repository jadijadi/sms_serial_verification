...
CALL_BACK_TOKEN = os.getenv('CALL_BACK_TOKEN', 'CALL BACK TOKEN')

# login cedentials
USERNAME = os.getenv('USERNAME', 'jadi')
PASSWORD = os.getenv('PASSWORD', 'pass')

# generate one strong secret key for flask.
SECRET_KEY = os.getenv('SECRET_KEY', 'random long string with alphanumeric + #()*&')
...
REMOTE_CALL_API_KEY = os.getenv('REMOTE_CALL_API_KEY', 'set_unguessable_remote_api_key_lkjdfljerlj3247LKJ')
